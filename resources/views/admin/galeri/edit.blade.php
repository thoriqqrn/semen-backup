...
@section('content')
    <div class="container-fluid">
        <h1 class="h3 mb-4 text-gray-800 fw-bold" style="color: #28a745;">Edit Item Galeri</h1>
            ...
            <div class="card-body">
                <form action="{{ route('admin.galeri.update', $galeri->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('tahun_kegiatan') is-invalid @enderror" id="tahun_kegiatan" name="tahun_kegiatan" value="{{ old('tahun_kegiatan', $galeri->tahun_kegiatan) }}" required min="1900" max="{{ date('Y') + 5 }}">
                    ...
                    <div class="mb-3">
                        <label for="file" class="form-label">Ganti File (Foto/Video) <small class="text-muted">(Kosongkan jika tidak ingin mengganti, Max 20MB)</small></label>
                        ...
                        @if ($galeri->file_path)
                            <div class="mt-2">
                                Current File:
                                @if ($galeri->tipe == 'foto')
                                    <img src="{{ asset('storage/' . $galeri->file_path) }}" alt="Current File" width="150">
                                @else
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="is_published" name="is_published" value="1" {{ old('is_published', $galeri->is_published) ? 'checked' : '' }}>
